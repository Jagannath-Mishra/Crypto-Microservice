 ...
 */
package com.justrightcrypto.exchange.commons.web.configuration.properties;
...
@Setter
@NoArgsConstructor
@ConfigurationProperties(prefix = "com.justrightcrypto.configuration.api.documentation")
